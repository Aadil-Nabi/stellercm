...
const products = [
  {
    name: 'Analytics',
    description:
      'Get a better understanding, if Thales CM is configured correctly as per best practices',
    href: '#',
    icon: ChartPieIcon,
  },
  {
  ...
  {
    name: 'Audit',
    description: 'Showcase your compliance with our audit tool',
    href: '#',
    icon: LockClosedIcon,
  },
  {
    name: 'Integrations',
    description: 'List all your integrations in one place',
    href: '#',
